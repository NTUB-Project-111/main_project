...
//       final analyzer = Provider.of<ReportAnalyzer>(context, listen: false);

//       await analyzer.loadData(asyncCallback: () async {
//         final isGuest = userProvider.isGuest;
//         final user = userProvider.user;

//         await report.loadData(
//           isGuest ? "2000" : (user?.birthday ?? "2000"),
...
//     final isLoading = Provider.of<ReportAnalyzer>(context).isLoading;
